...
export default function PostPage({ postsInfo }) {
  return (
    <>
      <HeadTag title={"Page " + postsInfo.currentPage + " | Fat Puppet"} link={"/posts/page/" + postsInfo.currentPage} image='portrait' description={"Fat Puppet is a humorous online publication written by Ashton Winters. Funny stories, offbeats essays, wacky lists—at Fat Puppet you can have it all."} />
