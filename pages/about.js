    ...
    <div>
      <HeadTag title="About | Writing with No Purpose" />
        ...
        <div className="flex justify-center mt-5">
          <div className="hidden item-center w-4/5 verticalindex:inline">
            ...
            <div>
              <p className="text-center italic text-lg verticalindex:text-2xl mt-3 mb-5 text-gray-600 font-medium">
                "Laughing at a puppet is funny. But laughing at a guy who thinks a puppet is funny is even funnier."
              </p>
              
              <p className="mb-5 text-lg verticalindex:text-2xl">
      ...
      <div className="content verticalindex:hidden">
          <div className="flex flex-col items-center">
            ...
            <div className="text-center flex flex-col p-4 w-4/5">
              <p className="italic text-xl text-center text-gray-600 mb-5">
                "Laughing at a puppet is funny. But laughing at a guy who thinks a puppet is funny is even funnier."
              </p>
      ...
      <div className="flex justify-center">
          <div className="item-center w-4/5 border-t">
            <p className="text-center bold text-lg verticalindex:text-4xl mt-5 mb-5">
              FAQs
            </p>

            <p className="text-left italic text-lg verticalindex:text-2xl mb-5">
              How often do you make new posts?
            </p>
            <p className="text-left text-lg verticalindex:text-2xl mb-10">
