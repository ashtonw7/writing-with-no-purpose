...
export default function ArticleCard({ title, author, quote, img, date, slug }) {
    ...
    return (
        <Link href={`/post/${slug}`}>
            ...
            <img className="object-scale-down w-2/5 h-2/5 verticalindex:h-auto regular:w-48 verticalindex:my-3 verticalindex:ml-3 verticalindex:mr-5" src={imageLink} alt={slug}/>
